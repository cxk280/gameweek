  ...
  green accents over deep navy fills).
    ...
    - **The ten stages** each have their own theme module (a static sky + back-to-front
      ...
      (the spire course also climbs) so racing works on every stage:
        ...
        6. **The Obsidian Spire** — a climbing course beneath a colossal tower: dramatic
           blue→sunset sky and a glowing field at its foot. (A literal vertical ascent that
           circles a rotating tower is a planned future enhancement.)
        ...
        10. **The Grand Athenaeum** — opulent library interior (receding hall as depth):
